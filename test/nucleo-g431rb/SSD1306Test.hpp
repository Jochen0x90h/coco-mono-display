...
/// @brief Drivers for SSD1306Test with Adafruit OLED bonnet
struct Drivers {
    Loop_TIM2 loop{APB1_TIMER_CLOCK};

    using I2cMaster = I2cMaster_I2C_DMA;
    I2cMaster i2c{loop,
        gpio::PA15 | gpio::AF4 | gpio::Config::DRIVE_DOWN | gpio::Config::PULL_UP, // SCL (CN7 38)
        gpio::PB7 | gpio::AF4 | gpio::Config::DRIVE_DOWN | gpio::Config::PULL_UP, // SDA (CN7 21)
        i2c::I2C1_INFO,
    ...
    I2cMaster::Buffer<1, DISPLAY_WIDTH * DISPLAY_HEIGHT / 8> displayBuffer{displayChannel};
